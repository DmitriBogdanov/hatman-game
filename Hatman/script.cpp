...
void scripts::LevelChange::update(Milliseconds elapsedTime) {
...
void scripts::LevelSwitch::update(Milliseconds elapsedTime) {
	if (Game::READ->level->player->solid->getHitbox().overlapsWithRect(this->hitbox)
...
void scripts::Portal::update(Milliseconds elapsedTime) {
	if (!this->activated
...
void scripts::Hint::update(Milliseconds elapsedTime) {
...
void scripts::Checkpoint::update(Milliseconds elapsedTime) {
