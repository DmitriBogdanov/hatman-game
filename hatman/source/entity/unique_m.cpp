...
void m::enemy::Sludge::update_when_aggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Sludge_consts;
...
void m::enemy::Sludge::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Sludge_consts;
...
void m::enemy::Worm::update_when_aggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Worm_consts;
...
void m::enemy::Worm::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Worm_consts;
...
void m::enemy::Golem::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Golem_consts;
...
void m::enemy::SkeletonHalberd::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace SkeletonHalberd_consts;
...
void m::enemy::PygmyWarrior::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace PygmyWarrior_consts;
...
void m::enemy::Devourer::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
...
void m::enemy::SpiritBomber::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
...
void m::enemy::CultistMage::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
...
void m::enemy::Hellhound::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Hellhound_consts;
...
void m::enemy::Necromancer::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
...
void m::enemy::Tentacle::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace Tentacle_consts;
...
void m::enemy::BossMage1::update_when_aggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace BossMage1_consts;
...
void m::enemy::BossMage1::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
...
void m::enemy::BossMage2::update_when_aggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace BossMage2_consts;
...
void m::enemy::BossMage2::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
...
void m::enemy::BossMage3::update_when_aggroed([[maybe_unused]] Milliseconds elapsedTime) {
	using namespace BossMage3_consts;
...
void m::enemy::BossMage3::update_when_deaggroed([[maybe_unused]] Milliseconds elapsedTime) {
	// Stand idle when deaggroed
}
